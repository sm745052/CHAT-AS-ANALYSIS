...
if __name__ == '__main__':
    ...
    parser.add_argument('--tkmax_length', type=int, default=100)
    parser.add_argument('--mdmax_length', type=int, default=5)
    ...
    infer_data = infer_data.sample(n=args.sample_size)
