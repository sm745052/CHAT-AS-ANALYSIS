...
models = ['qb', 't5', 'gpt2.sloss', 'mistral.prompt.word2', 'phi.prompt.word10', 'phi.finetune.word3', 'gpt4']

metrics = ["trigger_rate", "synctatic_match", "partial_recall", "partial_precision", "avg_pred_length", "thres"]
datas = ["ddc", "dstc7"]
